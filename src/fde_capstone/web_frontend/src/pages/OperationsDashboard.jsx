  ...
  return (
    <>
      <div className="hud-strip">
        <span className="hud-strip__live"><span className="pulse-dot" aria-hidden="true" /> Live telemetry</span>
        <span className="hud-strip__sep" aria-hidden="true" />
        <span>Policy <span className="hud-strip__id">{data.policy_version || 'academic-poc'}</span></span>
        <span className="hud-strip__sep" aria-hidden="true" />
        <span>Sample <span className="hud-strip__id">{data.sampled ?? '—'}</span> journeys</span>
      </div>
